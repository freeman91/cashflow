...
export default function FilterOptions(props) {
  ...
  const assetCategories = find(optionLists, { option_type: 'asset_category' });
              ...
              <List disablePadding sx={{ width: '100%', maxWidth: 350 }}>
                <ListItem disableGutters>
                  <StringFilter
                    label='account'
                    disabled={false}
                    stringFilter={accountFilter}
                    setStringFilter={setAccountFilter}
                    options={map(accounts, (account) => account.name)}
                  />
                </ListItem>
                <ListItem disableGutters>
                  <StringFilter
                    ...
                    options={assetCategories.options}
                  />
                </ListItem>
              </List>
            </Box>
