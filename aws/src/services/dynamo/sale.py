...
class Sale(BaseModel):
    ...
    def create(
        ...
        security = Security.get_(user_id, security_id)
    ...
    def withdraw(self) -> "Security":
        # Lazy import to avoid circular dependency
        from .security import Security

        security = Security.get_(self.user_id, self.security_id)
    ...
    def deposit(self) -> Account:
        account = Account.get_(self.user_id, self.deposit_to_id)
